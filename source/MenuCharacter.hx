...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'robo' => new CharacterSetting(0, 0, 1.6)
	];
	...
	public var cockBot:String = 'robo';
	
	public function new(x:Int, y:Int, scale:Float, flipped:Bool, ?cockBot:String = 'robo')
	{
		super(x, y);
		this.flipped = flipped;
		...
		/*case 'robo':
			...
			frames = Paths.getSparrowAtlas('cock');
			animation.addByPrefix('robo', "robo story", 24, false);
			...
			animation.addByPrefix('robo', "robo idle", 24, false);
