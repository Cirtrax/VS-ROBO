...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.animation.addByPrefix('bump', 'FNF ROBO', 24, false);
		logoBl.updateHitbox();
		// logoBl.screenCenter();
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			FlxTween.tween(logoBl, {y: logoBl.y + -800}, 0.6, {ease: FlxEase.quadInOut, type: PERSIST});
			FlxTween.tween(titleText, {y: titleText.y + 400}, 0.6, {ease: FlxEase.quadInOut, type: PERSIST});
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 10:
				deleteCoolText();
			case 11:
				createCoolText(['cool art', 'by']);
			// credTextShit.text += '\nlmao';
			case 12:
				addMoreText('Shiba Chichi and Mau187');
			// credTextShit.visible = false;
			...
			// credTextShit.visible = true;
			case 14:
				createCoolText(['cool cutscene', 'by']);
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('Serebeat'); // credTextShit.text += '\nFunkin';
			case 16:
				deleteCoolText();
			case 17:
			...
			case 19:
				deleteCoolText();
			case 21:
				createCoolText(['coding this']);
			case 22: 
				addMoreText('was slightly painful');
			case 23:
				addMoreText('lmao');
			case 24:
				deleteCoolText();
